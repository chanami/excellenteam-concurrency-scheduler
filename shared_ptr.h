#ifndef EXCELLENTEAM_ELLA_CONCURRENCY_SCHEDULER_CHANAMI_SHARED_PTR_H
#define EXCELLENTEAM_ELLA_CONCURRENCY_SCHEDULER_CHANAMI_SHARED_PTR_H
...
#endif //EXCELLENTEAM_ELLA_CONCURRENCY_SCHEDULER_CHANAMI_SHARED_PTR_H
